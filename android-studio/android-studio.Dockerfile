...
#graphic
RUN pacman -S --noconfirm mesa mesa-demos mesa-utils libva
RUN pacman -S --noconfirm xf86-video-amdgpu vulkan-radeon
...
#gui_app
RUN sudo -u arch -- paru -S --noconfirm firefox android-studio jdk-openjdk

RUN mkdir -p /root/Android/
RUN mkdir -p /root/Android-project
